...
8. owner 欄位只能填以下名單中「完全對應」的其中一個正式姓名，不可自創、不可加前綴或後綴、
   ...
   呂理論、徐碧惠、黃湘婷、廖淑慧、吳哲緯、王治先、黃文彬、艾里、阿蔡
   （日誌裡可能出現簡稱，例如「文彬」對應「黃文彬」、「治先」對應「王治先」、「湘婷」對應「黃湘婷」、
   「淑慧」對應「廖淑慧」、「哲緯」對應「吳哲緯」、「理論」對應「呂理論」、「碧惠」對應「徐碧惠」，
   請對應成完整正式姓名再填入 owner）。若判斷出來的人名不在上述名單、或無法明確對應到其中一位，
   一律放進 unassigned_tasks，不可以硬塞一個名單外的名字進 owner。
